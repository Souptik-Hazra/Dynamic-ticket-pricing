...
class PeakHourDetector:
    ...
    def __init__(self):
        ...
        self.model_info = {
            ...
            'off_peak_hours': list(range(0, 6)) + list(range(22, 24))  # Midnight to 6 AM, 10 PM onwards
        }
    ...
    def predict_peak_hours(self):
        ...
        moderate_hours = [h for h in hours if h not in peak_hours and h not in off_peak_hours]
        ...
        return {
            ...
            'best_hours': sorted(peak_hours, key=lambda h: self.hourly_multipliers[h], reverse=True)[:3],
            'worst_hours': sorted(off_peak_hours, key=lambda h: self.hourly_multipliers[h])[:3]
        }
    ...
    def predict_demand_for_event(self, event_data):
        ...
        # Combine all factors
        final_multiplier = hourly_mult * weekly_mult * category_mult * popularity_boost * lifecycle_mult
        ...
        return {
            ...
            'recommendation': self.get_pricing_recommendation(final_multiplier, demand_level)
        }
